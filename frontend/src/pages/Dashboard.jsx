        ...
        {activeTab === 'reports' ? (
          myReports.length === 0 ? (
            <div className="bg-white border border-slate-200 rounded-2xl p-10 text-center max-w-md mx-auto">
              ...
              <h3 className="text-base font-bold text-slate-900">You haven't reported any issues yet</h3>
              <p className="text-xs text-slate-500 mt-1">Spotted a pothole or sewage leak? Report it to local authorities.</p>
              <Link to="/report" className="inline-block mt-4 px-4 py-2 bg-sky-600 text-white text-xs font-bold rounded-lg">
                Report an Issue
              </Link>
            </div>
          ) : (
